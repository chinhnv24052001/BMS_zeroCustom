...
using tmss.Web.Authentication.TwoFactor;
using tmss.Web.Models.TokenAuth;
...
using tmss.Web.Authentication.External;
...
namespace tmss.Web.Controllers
{
    ...
    public class TokenAuthController : tmssControllerBase
    {
        ...
        public async Task SendTwoFactorAuthCode([FromBody] SendTwoFactorAuthCodeModel model)
        {
            ...
            if (model.Provider != GoogleAuthenticatorProvider.Name)
            {
                ...
                if (model.Provider == "Email")
                {
                    ...
                    {
                        To = await _userManager.GetEmailAsync(user),
