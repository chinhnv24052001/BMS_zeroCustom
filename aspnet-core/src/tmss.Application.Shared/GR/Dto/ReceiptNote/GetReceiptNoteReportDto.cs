...
{
    public class GetReceiptNoteReportDto
    {
        ...
        public int FromType { get; set; } //0: Receipt Note, 1: Acceptance Note 
        public List<InputRcvReceiptNoteLinesDto> RNLines { get; set; }
