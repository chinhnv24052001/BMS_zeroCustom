...
@Component({
    selector: 'app-create-or-edit-quota-expense',
    templateUrl: './create-or-edit-quota-expense.component.html',
    styleUrls: ['./create-or-edit-quota-expense.component.less']
})
export class CreateOrEditQuotaExpenseComponent extends AppComponentBase implements OnInit {
    ...
    getCache() {
        ...
        this._mstProjectServiceProxy.getAllMstInventoryGroup().subscribe((val) => {
            ...
            forEach(val, (item) => {
                this.listInventory.push({ label: item.code, value: item.code })
            });
        });
