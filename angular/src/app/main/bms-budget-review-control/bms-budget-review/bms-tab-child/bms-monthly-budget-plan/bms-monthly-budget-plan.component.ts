...
@Component({
  selector: 'app-bms-monthly-budget-plan',
  templateUrl: './bms-monthly-budget-plan.component.html',
  styleUrls: ['./bms-monthly-budget-plan.component.css']
})
export class BmsMonthlyBudgetPlanComponent extends AppComponentBase implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.gridColDef = [
      ...
      // },
      {
        headerName: this.l('Fin Status'),
        headerTooltip: this.l('FinStatus'),
        children: [
          {
            headerName: "",
            headerTooltip: "",
      ...
      {
        headerName: this.l('Payment Setting'),
        headerTooltip: this.l('Payment Setting'),
        children: [
          {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                headerName: this.l('Transfer/Add on'),
                headerTooltip: this.l('Transfer/Add on'),
                field: 'transferAddOn'
              },
            ]
          },
          {
            ...
            children: [
              ...
              {
                headerName: this.l('Non-Purchase'),
                headerTooltip: this.l('Non-Purchase'),
                field: 'nonPurchaseSummary'
              },
            ]
          },
          {
            headerName: this.l('Encumbrance'),
            headerTooltip: this.l('Encumbrance'),
            children: [
              {
                headerName: this.l('Encumbrance'),
                headerTooltip: this.l('Encumbrance'),
          ...
          },
          {
            ...
            children: [
              {
                headerName: this.l('Remaining'),
                headerTooltip: this.l('Remaining'),
                field: 'remaining'
              },
            ]
          },
      ...
      {
        headerName: this.l('Status Budget Review'),
        headerTooltip: this.l('Status Budget Review'),
        children: [
          {
            headerName: this.l('Dept.'),
            headerTooltip: this.l('Dept.'),
            children: [
              {
                headerName: this.l('Check'),
                headerTooltip: this.l('Check'),
                field: 'deptCheck'
              },
              {
          ...
          {
            headerName: this.l('Finance'),
            headerTooltip: this.l('Finance'),
            children: [
              {
                headerName: this.l('Remark'),
                headerTooltip: this.l('Remark'),
