...
@Component({
  selector: "app-add-user-step-modal",
  templateUrl: "./add-user-step-modal.component.html",
  styleUrls: ["./add-user-step-modal.component.scss"]
})

export class AddUserStepModalComponent extends AppComponentBase implements OnInit{
  ...
  save(){
    ...
    if (!this.note ||  this.note == "") return this.notify.warn("Vui lòng ghi lại lý do bỏ qua bước duyệt")
    let body = {
        userId: this.userId,
        stepId: this.stepId,
        note: this.note,
